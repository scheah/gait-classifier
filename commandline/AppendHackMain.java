...
public class AppendHackMain {

    public static void addFilesFromDir(AppendHackTimeFrequencyClassifier classifier, String directoryPath, String className) {
    ...
    public static void processHMPData(int classOption) {
        ...
        String [] userClasses = new String[]{"f1", "f2", "f3", "f4", "f5", "m1", "m2", "m3", "m4", "m5", "m6", "m7", "m8", "m9",
            "m10", "m11"};
        AppendHackTimeFrequencyClassifier m_classifier = null;
        if (classOption == 1) {
            m_classifier = new AppendHackTimeFrequencyClassifier(actionClasses);
            ...
            m_classifier = new AppendHackTimeFrequencyClassifier(userClasses);
