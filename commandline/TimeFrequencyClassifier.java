 ...
 */
public class TimeFrequencyClassifier {
    private static final String TAG = "TimeFrequencyClassifier";
    private Instances m_Data;
    private Classifier m_Classifier;
    private String [] m_Classes;

    public TimeFrequencyClassifier(String [] classes) {
        m_Classes = classes;
        m_Data = initializeTransformedDataFormat2();
        m_Classifier = new RandomForest();
    }

    public void loadGaitData(BufferedReader reader, String userid, String filename) throws Exception {
        readData(reader, userid, filename);
    }
    ...
    public void saveArff() throws Exception {
        Instances dataSet = m_Data;
        ArffSaver saver = new ArffSaver();
        saver.setInstances(dataSet);
        saver.setFile(new File("./arff/test.arff"));
        saver.setDestination(new File("./arff/test.arff"));   // **not** necessary in 3.5.4 and later
        saver.writeBatch();
    }
    ...
    public static double[] join(double [] ... parms) {
        // calculate size of target array
        int size = 0;
        for (double[] array : parms) {
          size += array.length;
        }
    ...
    private void readData(BufferedReader reader, String userid, String filename) throws Exception {
        ...
        while ((mLine = reader.readLine()) != null) {
            ...
            if (mLine.contains(":") || mLine.contains("="))
                ...
                iDataPoint = new DenseInstance(22);
                iDataPoint.setValue(m_Data.attribute("Mean x"), Double.parseDouble(data[0]));
                iDataPoint.setValue(m_Data.attribute("Mean y"), Double.parseDouble(data[1]));
                iDataPoint.setValue(m_Data.attribute("Mean z"), Double.parseDouble(data[2]));
                iDataPoint.setValue(m_Data.attribute("Variance x"), Double.parseDouble(data[3]));
                iDataPoint.setValue(m_Data.attribute("Variance y"), Double.parseDouble(data[4]));
                iDataPoint.setValue(m_Data.attribute("Variance z"), Double.parseDouble(data[5]));
                iDataPoint.setValue(m_Data.attribute("Standard Deviation x"), Double.parseDouble(data[6]));
                iDataPoint.setValue(m_Data.attribute("Standard Deviation y"), Double.parseDouble(data[7]));
                iDataPoint.setValue(m_Data.attribute("Standard Deviation z"), Double.parseDouble(data[8]));
                iDataPoint.setValue(m_Data.attribute("Minimum x"), Double.parseDouble(data[9]));
                iDataPoint.setValue(m_Data.attribute("Minimum y"), Double.parseDouble(data[10]));
                iDataPoint.setValue(m_Data.attribute("Minimum z"), Double.parseDouble(data[11]));
                iDataPoint.setValue(m_Data.attribute("Average Absolute Sample Difference x"), Double.parseDouble(data[12]));
                iDataPoint.setValue(m_Data.attribute("Average Absolute Sample Difference y"), Double.parseDouble(data[13]));
                iDataPoint.setValue(m_Data.attribute("Average Absolute Sample Difference z"), Double.parseDouble(data[14]));
                iDataPoint.setValue(m_Data.attribute("Correlation xy"), Double.parseDouble(data[15]));
                iDataPoint.setValue(m_Data.attribute("Correlation xz"), Double.parseDouble(data[16]));
                iDataPoint.setValue(m_Data.attribute("Correlation yz"), Double.parseDouble(data[17]));
                iDataPoint.setValue(m_Data.attribute("userid"), Double.parseDouble(data[18])); // HACK, misordered
                iDataPoint.setValue(m_Data.attribute("Spectral Energy x"), Double.parseDouble(data[19]));
                iDataPoint.setValue(m_Data.attribute("Spectral Energy y"), Double.parseDouble(data[20]));
                iDataPoint.setValue(m_Data.attribute("Spectral Energy z"), Double.parseDouble(data[21]));
